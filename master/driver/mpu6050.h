...
void getGyro_offset(void);

void RadTransform(SI_F_XYZ *gyro_in,SI_F_XYZ *gyro_out);
void DegTransform(SI_F_XYZ *gyro_raw_filter,SI_F_XYZ *gyro_deg_out);
void AccDataTransToG(SI_F_XYZ *acc_in,SI_F_XYZ *acc_out);
...
extern S16_XYZ  gyroRaw;
extern S16_XYZ  accRaw;
extern SI_F_XYZ acc_1_lpf;
extern SI_F_XYZ acc_bt_lpf;
extern SI_F_XYZ gyro_lpf;
extern SI_F_XYZ gyro_offset;

extern SI_F_XYZ accButterworthData;
extern SI_F_XYZ gyroButterworthData;
